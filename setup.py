...
setuptools.setup(
    name="youtubetask",
    version="1.0.0",
    description="Python project to play with YouTube API",
    # Allow UTF-8 characters in README with encoding argument.
    long_description=project_dir.joinpath(
        "README.md").read_text(encoding="utf-8"),
    keywords=["python"],
    author="",
    url="https://github.com/shaantalk/YoutubeAPI",
    ...
    package_data={"youtubeTask": ["py.typed"]},
    ...
    entry_points={"console_scripts": ["youtubeTask=youtubeTask.cli:main"]},
)
